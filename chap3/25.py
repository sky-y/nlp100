...
list_found = re.findall(pattern_str2, str_body, re.MULTILINE | re.VERBOSE | re.DOTALL)
od_result = OrderedDict(list_found)
...
#              ('国章リンク', '（[[イギリスの国章|国章]]）'),
#              ('標語',
#               '{{lang|fr|[[Dieu et mon droit]]}}<br />（[[フランス語]]:[[Dieu et mon '
#               'droit|神と我が権利]]）'),
#              ('国歌',
#               '[[女王陛下万歳|{{lang|en|God Save the Queen}}]]{{en icon}}<br '
#               "/>''神よ女王を護り賜え''<br />{{center|[[ファイル:United States Navy Band - "
#               'God Save the Queen.ogg]]}}'),
#              ('地図画像', 'Europe-UK.svg'),
#              ('位置画像',
#               'United Kingdom (+overseas territories) in the World '
#               '(+Antarctica claims).svg'),
#              ('公用語', '[[英語]]'),
#              ('首都', '[[ロンドン]]（事実上）'),
#              ('最大都市', 'ロンドン'),
#              ('元首等肩書', '[[イギリスの君主|女王]]'),
...
#               'and Statistics>World Economic Outlook Databases>By '
...
#              ('建国形態', '建国'),
#              ('確立形態1',
#               '[[イングランド王国]]／[[スコットランド王国]]<br />（両国とも[[合同法 '
#               '(1707年)|1707年合同法]]まで）'),
#              ('確立年月日1', '927年／843年'),
